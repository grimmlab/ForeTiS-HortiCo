...
if __name__ == '__main__':
    ...
    parser.add_argument("-data", "--data", nargs='+',
                        default=['blumenzentrale', 'heusser', 'keller', 'offenloch', 'peters', 'schachtschneider'], #
                        help="specify the dataset that you want to use.")
    parser.add_argument("-retailer", "--retailer", type=str,
                        default='heusser',
                        help="specify the retailer that you want to use.")
    ...
    parser.add_argument("-ty", "--test_year", type=int, default=2020,
    ...
    parser.add_argument("-scalethr", "--scale_thr", type=float, default=None,
                        help="Only relevant for evars-gpr(++): specify output scale threshold. If nothing is specified,"
                             "it will be considered as a hyperparameter for optimization.")
    parser.add_argument("-scaleseas", "--scale_seasons", type=int, default=200,

...
class TorchModel(_base_model.BaseModel, abc.ABC):
    """
    Parent class based on :obj:`~ForeTiSHortiCo-Hortico.model._base_model.BaseModel` for all PyTorch models to share functionalities.
    ...
    *Attributes*
    ...
    def common_hyperparams():
        ...
        Also See :obj:`~ForeTiSHortiCo-Hortico.model._base_model.BaseModel` for more information
        """
        return {
            'dropout': {
                'datatype': 'float',

...
class TemplateTensorflowModel(_tensorflow_model.TensorflowModel):
    """
    Template file for a prediction model based on :obj:`~ForeTiSHortico-Hortico.model._tensorflow_model.TensorflowModel`

    See :obj:`~ForeTiSHortico-Hortico.model._base_model.BaseModel` and :obj:`~ForeTiSHortico-Hortico.model._tensorflow_model.TensorflowModel`
    ...
    **Steps you have to do to add your own model:**
        ...
        2. Rename the class and add it to *ForeTiSHortico-Hortico.model.__init__.py*
        ...
        5. Define the hyperparameters and ranges you want to use for optimization in *define_hyperparams_to_tune()*.
           ...
           CAUTION: Some hyperparameters are already defined in :obj:`~ForeTiSHortico-Hortico.model._tensorflow_model.TensorflowModel.common_hyperparams()`,
           which you can directly use here. Some of them are already suggested in :obj:`~ForeTiSHortico-Hortico.model.tensorflow_model.TensorflowModel`.
    ...
    def define_hyperparams_to_tune(self) -> dict:
        ...
        See :obj:`~ForeTiSHortico-Hortico.model._base_model.BaseModel` for more information on the format and options.

        Check :obj:`~ForeTiSHortico-Hortico.model._tensorflow_model.TensorflowModel` for already defined (and for some cases also suggested) hyperparameters.
        """
        return {
            'example_param_1': {

...
class SklearnModel(_base_model.BaseModel, abc.ABC):
    """
    Parent class based on :obj:`~ForeTiSHortico-Hortico.model._base_model.BaseModel` for all models with a sklearn-like API to share
    functionalities. See :obj:`~ForeTiSHortico-Hortico.model._base_model.BaseModel` for more information.

    **Attributes**

        *Inherited attributes*

        See :obj:`~ForeTiSHortico-Hortico.model._base_model.BaseModel`
    """

...
class LSTM(_torch_model.TorchModel):
    ...
    See :obj:`~ForeTiSHortico-Hortico.model._base_model.BaseModel` and :obj:`~ForeTiSHortico-Hortico.model._torch_model.TorchModel` for more information on the attributes.
    """
    ...
    def define_hyperparams_to_tune(self) -> dict:
        ...
        See :obj:`~ForeTiSHortico-Hortico.model._torch_model.TorchModel` for more information on hyperparameters common for all torch models.
        """
        return {
            'lstm_hidden_dim': {
                'datatype': 'int',

...
if __name__ == '__main__':
    ...
    parser.add_argument("-data", "--data", type=str, default='fleurop-own',
                        help="specify the dataset that you want to use.")
    parser.add_argument("-tc", "--target_column", type=str, default='Simply the best_amount',
    ...
    parser.add_argument("-mod", "--models", nargs='+', default=['mlpbayes', 'mlp'],

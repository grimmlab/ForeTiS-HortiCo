...
class TemplateTensorflowModel(_tensorflow_model.TensorflowModel):
    """
    Template file for a prediction model based on :obj:`~ForeTiS-Hortico.model._tensorflow_model.TensorflowModel`

    See :obj:`~ForeTiS-Hortico.model._base_model.BaseModel` and :obj:`~ForeTiS-Hortico.model._tensorflow_model.TensorflowModel`
    ...
    **Steps you have to do to add your own model:**
        ...
        5. Define the hyperparameters and ranges you want to use for optimization in *define_hyperparams_to_tune()*.
           ...
           CAUTION: Some hyperparameters are already defined in :obj:`~ForeTiS-Hortico.model._tensorflow_model.TensorflowModel.common_hyperparams()`,
           which you can directly use here. Some of them are already suggested in :obj:`~ForeTiS-Hortico.model.tensorflow_model.TensorflowModel`.
    ...
    def define_hyperparams_to_tune(self) -> dict:
        ...
        Check :obj:`~ForeTiS-Hortico.model._tensorflow_model.TensorflowModel` for already defined (and for some cases also suggested) hyperparameters.
        """
        return {
            'example_param_1': {
